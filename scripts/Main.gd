...
# Contracts
@onready var lbl_contract_coal  : Label   = $Screens/GameScreen/RightSidebar/Margin/VBox/Contracts/RowCoal/LblOffer
@onready var lbl_contract_solar : Label   = $Screens/GameScreen/RightSidebar/Margin/VBox/Contracts/RowSolar/LblOffer
@onready var lbl_contract_wind  : Label   = $Screens/GameScreen/RightSidebar/Margin/VBox/Contracts/RowWind/LblOffer
@onready var btn_contract_coal  : Button  = $Screens/GameScreen/RightSidebar/Margin/VBox/Contracts/RowCoal/BtnAccept
@onready var btn_contract_solar : Button  = $Screens/GameScreen/RightSidebar/Margin/VBox/Contracts/RowSolar/BtnAccept
@onready var btn_contract_wind  : Button  = $Screens/GameScreen/RightSidebar/Margin/VBox/Contracts/RowWind/BtnAccept

# Capacity
@onready var lbl_cap_coal   : Label = $Screens/GameScreen/RightSidebar/Margin/VBox/Capacity/RowCoal/LblCap
@onready var lbl_cap_solar  : Label = $Screens/GameScreen/RightSidebar/Margin/VBox/Capacity/RowSolar/LblCap
@onready var lbl_cap_wind   : Label = $Screens/GameScreen/RightSidebar/Margin/VBox/Capacity/RowWind/LblCap
@onready var btn_cap_coal   : Button = $Screens/GameScreen/RightSidebar/Margin/VBox/Capacity/RowCoal/BtnBuy
@onready var btn_cap_solar  : Button = $Screens/GameScreen/RightSidebar/Margin/VBox/Capacity/RowSolar/BtnBuy
@onready var btn_cap_wind   : Button = $Screens/GameScreen/RightSidebar/Margin/VBox/Capacity/RowWind/BtnBuy

# Emergency boost
@onready var lbl_boost_status : Label = $Screens/GameScreen/RightSidebar/Margin/VBox/Boost/RowStatus/LblStatus
@onready var btn_boost_coal   : Button = $Screens/GameScreen/RightSidebar/Margin/VBox/Boost/RowButtons/BtnBoostCoal
@onready var btn_boost_solar  : Button = $Screens/GameScreen/RightSidebar/Margin/VBox/Boost/RowButtons/BtnBoostSolar
@onready var btn_boost_wind   : Button = $Screens/GameScreen/RightSidebar/Margin/VBox/Boost/RowButtons/BtnBoostWind
...
# Event panel
@onready var panel_event      : PanelContainer = $Screens/GameScreen/RightSidebar/Margin/VBox/EventPanel
@onready var lbl_event_title  : Label          = $Screens/GameScreen/RightSidebar/Margin/VBox/EventPanel/VBox/LblTitle
@onready var lbl_event_desc   : Label          = $Screens/GameScreen/RightSidebar/Margin/VBox/EventPanel/VBox/LblDesc
@onready var timer_event_hide : Timer          = $Screens/GameScreen/RightSidebar/Margin/VBox/EventPanel/HideTimer

# Flash contract panel
@onready var panel_flash      : PanelContainer = $Screens/GameScreen/RightSidebar/Margin/VBox/FlashPanel
@onready var lbl_flash_title  : Label          = $Screens/GameScreen/RightSidebar/Margin/VBox/FlashPanel/VBox/LblFlashTitle
@onready var lbl_flash_desc   : Label          = $Screens/GameScreen/RightSidebar/Margin/VBox/FlashPanel/VBox/LblFlashDesc
@onready var bar_flash_timer  : ProgressBar    = $Screens/GameScreen/RightSidebar/Margin/VBox/FlashPanel/VBox/FlashTimerBar
@onready var btn_flash_accept : Button         = $Screens/GameScreen/RightSidebar/Margin/VBox/FlashPanel/VBox/BtnFlashAccept
...
# Upgrade buttons
@onready var btn_battery      : Button = $Screens/GameScreen/RightSidebar/Margin/VBox/Upgrades/BtnBattery
@onready var btn_grid         : Button = $Screens/GameScreen/RightSidebar/Margin/VBox/Upgrades/BtnGrid
@onready var btn_better_solar : Button = $Screens/GameScreen/RightSidebar/Margin/VBox/Upgrades/BtnBetterSolar
@onready var btn_stable_wind  : Button = $Screens/GameScreen/RightSidebar/Margin/VBox/Upgrades/BtnStableWind
...
func _on_boost_state_updated(ready: bool, cooldown: float) -> void:
	if ready:
